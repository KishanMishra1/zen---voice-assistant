...
#         if 'conda' in query:
#             os.startfile("C:\Users\kishan\anaconda3")
...
class MainThread(QThread):
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            if "hello" or "hi" or "hey" or "zen" in self.query:
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("../SciFi_LoaderBlue.gif")
